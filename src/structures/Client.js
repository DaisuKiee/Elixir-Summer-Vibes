import { Client, Routes, REST, PermissionsBitField, ApplicationCommandType, GatewayIntentBits, Partials, Collection, ContainerBuilder, TextDisplayBuilder, SectionBuilder, SeparatorBuilder, MessageFlags } from 'discord.js';
