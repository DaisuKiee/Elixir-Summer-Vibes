...
export default class Context {
    ...
    sendMessage(content) {
        // Auto-detect if content contains components and add the flag
        if (content && content.components && !content.embeds) {
            content.flags = content.flags || MessageFlags.IsComponentsV2;
        }
