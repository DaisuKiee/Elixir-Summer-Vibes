    ...
    async run(ctx, args) {
        ...
        try {
            ...
            container.addTextDisplayComponents(
                (textDisplay) => textDisplay.setContent(`✅ Successfully reloaded command: \`${newCommand.name}\``)
            );
            ...
            container.addTextDisplayComponents(
                (textDisplay) => textDisplay.setContent(`❌ Error reloading command: \`${commandName}\`\n\`\`\`js\n${error.message}\n\`\`\``)
            );
